...
export class StreamPage {
  ...
  ionViewDidLoad() {
    ...
    this.http.get('http://localhost/CAPSTONE/php/index.php/live_latest').subscribe(data => {
  ...
  this.http.get('http://localhost/CAPSTONE/php/index.php/video').subscribe(data => {
    // Read the result field from the JSON response.
    //this.results = JSON.stringify(data);  
   // this.img.nativeElement.src= data[0]['ministryimage'];
   this.aurl = data;
