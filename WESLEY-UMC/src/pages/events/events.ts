...
export class EventsPage {
  ...
  ionViewDidLoad() {
    ...
    this.http.get('http://localhost/capstone/php/allevents.php').subscribe(data => {
    ...
    this.http.get('http://localhost/capstone/php/registerdevent.php?user='+this.a).subscribe(data => {
      // Read the result field from the JSON response.
      //this.results = JSON.stringify(data);  
     // this.img.nativeElement.src= data[0]['ministryimage'];
    ...
    console.log('ionViewDidLoad EventsPage');
    this.http.get('http://localhost/capstone/php/todaysevent.php').subscribe(data1 => {
      // Read the result field from the JSON response.
      //this.results = JSON.stringify(data);  
     // this.img.nativeElement.src= data[0]['ministryimage'];
     this.today = data1;
