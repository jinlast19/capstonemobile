...
devotion(){
  ...
  all(){
    ...
    loader.present();
    console.log("all");
    this.http.get('http://localhost/CAPSTONE/php/index.php/random').subscribe(data => {
  ...
  my(){
    ...
    this.http.get('http://localhost/CAPSTONE/php/index.php/random2/'+this.new['name']).subscribe(data => {
      // Read the result field from the JSON response.
      //this.results = JSON.stringify(data);  
     // this.img.nativeElement.src= data[0]['ministryimage'];
     this.results = data;
  ...
  this.http.get('http://localhost/CAPSTONE/php/devotions.php/add/'+this.adduser+'/'+a).subscribe(datas => {
    // Read the result field from the JSON response.
    //this.results = JSON.stringify(data);  
  ...
  ionViewDidLoad() {
    this.http.get('http://localhost/CAPSTONE/php/index.php/latest').subscribe(data => {
      // Read the result field from the JSON response.
      //this.results = JSON.stringify(data);  
     // this.img.nativeElement.src= data[0]['ministryimage'];
     this.devotions = data;
